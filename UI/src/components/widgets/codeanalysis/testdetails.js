(function () {
    ...
    function TestDetailsController($scope, $uibModalInstance, testResult, DashStatus) {
        ...
        $scope.showTestSuiteDetail = function (testSuite) {
			...
			//alert("showTestSuiteDetail::::TestSuite Description ::::"+testSuite.description);
			...
			//alert("showTestSuiteDetail::::TestSuite Description -Scope::::"+$scope.activeSuite);
        };
        $scope.showTestCaseDetail = function (testCase) {
			//alert("showTestCaseDetail::::TestCAse Description ::::"+testCase.description);
			...
			//alert("showTestCaseDetail::::TestCAse Description -Scope ::::"+$scope.activeCase);
        };
