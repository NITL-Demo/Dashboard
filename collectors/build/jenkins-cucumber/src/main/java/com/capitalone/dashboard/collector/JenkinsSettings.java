...
public class JenkinsSettings {
	...
	private String cucumberTestNgRegex = "testng-results.xml";
	...
	public String getCucumberTestNgRegex() {
        return cucumberTestNgRegex;
    }

    public void setCucumberTestNgRegex(String cucumberTestNgRegex) {
        this.cucumberTestNgRegex = cucumberTestNgRegex;
    }
